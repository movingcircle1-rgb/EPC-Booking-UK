...
export default function Navbar() {
  ...
  return (
    <>
      <div className="bg-[#e71c5e]/90 backdrop-blur-md text-white py-2 px-2 sm:px-4 relative z-50">
                      ...
                      {serviceMenu.map((item) => {
                          ...
                          return (
                            <button
                              ...
                              className={`flex w-full items-center justify-between px-4 py-3 text-left text-sm font-semibold transition-colors ${
                                isActive
                                  ? 'bg-gray-50 text-[#e71c5e]'
                                  : 'text-[#293132] hover:bg-gray-50 hover:text-[#e71c5e]'
                              }`}
                            >
                        ...
                        return (
                          <a
                            ...
                            className="block w-full text-left px-4 py-3 text-sm font-semibold text-[#293132] hover:text-[#e71c5e] hover:bg-gray-50 transition-colors"
                          >
                      ...
                      <div className="bg-white shadow-xl border border-l-0 border-gray-200 rounded-r-lg py-2 min-w-[320px] max-h-[70vh] overflow-y-auto">
                        ...
                        {activeServiceParent.children.map((child) => (
                          <a
                            ...
                            onClick={() => setActiveDropdown(null)}
                            className="block w-full text-left px-4 py-3 text-sm text-[#293132] hover:text-[#e71c5e] hover:bg-gray-50 transition-colors"
                          >
                  ...
                  <div className="absolute top-full right-0 mt-0 z-50 flex flex-row-reverse">
                    <div className="bg-white shadow-xl border border-gray-200 rounded-l-lg py-3 min-w-[280px]">
                      <a
                        ...
                        className="block w-full text-left px-4 py-2 text-sm font-semibold text-[#293132] hover:text-[#e71c5e] hover:bg-gray-50 transition-colors"
                      >
                        View all locations
                      </a>
