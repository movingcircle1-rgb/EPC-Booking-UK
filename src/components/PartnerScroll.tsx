        ...
        <div className="relative">
          ...
          >
            {[...partners, ...partners].map((partner, index) => (
              <div
                key={index}
                className="flex-shrink-0 flex items-center justify-center h-24 w-48 bg-gray-50 rounded-lg border-2 border-gray-200 hover:border-[#be0e0c] hover:shadow-lg transition-all"
              >
