      ...
      <div className="bg-white rounded-xl shadow-lg border border-gray-200">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-semibold transition-all ${
                  selectedCategory === category
                    ? 'bg-[#be0e0c] text-white shadow-md'
          ...
          {filteredMaterials.length === 0 ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredMaterials.map((material) => (
                <div
                  key={material.id}
                  className="border-2 border-gray-200 rounded-xl p-6 hover:shadow-lg hover:border-[#be0e0c] transition-all"
                >
                  <div className="flex items-start justify-between mb-4">
                    <div className="w-12 h-12 bg-gray-100 rounded-lg flex items-center justify-center">
                      {getFileIcon(material.file_type)}
                    </div>
                    <span className="px-3 py-1 bg-[#be0e0c] bg-opacity-10 text-[#be0e0c] text-xs font-bold rounded-full">
                      {material.category}
                    </span>
                  </div>
                  ...
                  <div className="flex gap-2">
                    {material.is_downloadable && (
                      <button
                        ...
                        className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-[#be0e0c] text-white rounded-lg hover:bg-[#9f0b0a] transition-colors text-sm font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                      >
        ...
        <div className="p-6 bg-gray-50 border-t border-gray-200">
          <div className="flex items-start gap-3">
            <ExternalLink size={20} className="text-[#be0e0c] flex-shrink-0 mt-1" />
            <div>
            ...
            <form onSubmit={handleOrderSubmit} className="p-6 space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex-1 px-6 py-3 bg-[#be0e0c] text-white rounded-lg hover:bg-[#9f0b0a] transition-colors font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                >
