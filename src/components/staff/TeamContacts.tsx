  ...
  const ContactCard = ({ person, isManager = false }: { person: any; isManager?: boolean }) => (
    <div className={`border-2 rounded-lg p-4 ${
      ...
      <div className="flex items-center gap-4">
        <div className="w-16 h-16 bg-gradient-to-br from-[#be0e0c] to-[#9f0b0a] rounded-full flex items-center justify-center text-white text-xl font-bold">
          ...
          <div className="space-y-1">
            {person.email && (
              <div className="flex items-center gap-2 text-sm text-gray-700">
                ...
                <a href={`mailto:${person.email}`} className="hover:text-[#be0e0c] transition-colors">
                  {person.email}
                </a>
              </div>
            )}
            {person.phone && (
              <div className="flex items-center gap-2 text-sm text-gray-700">
                ...
                <a href={`tel:${person.phone}`} className="hover:text-[#be0e0c] transition-colors">
                  {person.phone}
                </a>
              </div>
            )}
