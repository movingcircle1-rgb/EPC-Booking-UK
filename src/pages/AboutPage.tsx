        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white rounded-xl p-8 shadow-lg text-center">
              <div className="w-16 h-16 bg-[#be0e0c] rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              <div className="border-l-4 border-[#be0e0c] pl-6">
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="bg-white rounded-xl p-8 shadow-lg">
                <div className="text-5xl font-bold text-[#be0e0c] mb-2">25+</div>
                <div className="text-gray-600">Years of Experience</div>
              </div>

              <div className="bg-white rounded-xl p-8 shadow-lg">
                <div className="text-5xl font-bold text-[#be0e0c] mb-2">50K+</div>
                <div className="text-gray-600">Successful Moves</div>
              </div>

              <div className="bg-white rounded-xl p-8 shadow-lg">
                <div className="text-5xl font-bold text-[#be0e0c] mb-2">100+</div>
                <div className="text-gray-600">Professional Staff</div>
              </div>

              <div className="bg-white rounded-xl p-8 shadow-lg">
                <div className="text-5xl font-bold text-[#be0e0c] mb-2">98%</div>
