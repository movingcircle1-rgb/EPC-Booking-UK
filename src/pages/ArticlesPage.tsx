            ...
            <button
              ...
              className={`px-6 py-2 rounded-full font-medium transition-all ${
                selectedCategory === category
                  ? 'bg-[#e71c5e] text-white shadow-lg'
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {filteredArticles.map((article) => (
              ...
              >
                {article.featured_image && (
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4">
                      <span className="px-3 py-1 bg-[#e71c5e] text-white text-sm font-medium rounded-full">
                        {article.category}
                      </span>
                    </div>
                  </div>
                ...
                <div className="p-6">
                  <h2 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-[#e71c5e] transition-colors line-clamp-2">
                    {article.title}
                  </h2>
                  ...
                  <div className="flex items-center text-[#e71c5e] font-medium">
                    Read More
