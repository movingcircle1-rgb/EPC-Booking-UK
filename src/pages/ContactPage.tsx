          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-[#be0e0c] rounded-full flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-1">
                      ...
                      <a
                        ...
                        className="text-[#be0e0c] hover:underline"
                      >
              ...
              <div className="mt-8 bg-[#be0e0c]/10 rounded-xl p-6 border border-[#be0e0c]/20">
                <h3 className="font-bold text-lg mb-3 text-[#be0e0c]">
                ...
                <a
                  href={brandConfig.contact.phoneSecondaryHref}
                  className="text-[#be0e0c] font-semibold hover:underline"
                >
                  {brandConfig.contact.phoneSecondary}
                </a>
              </div>
            ...
            <div>
              <div className="bg-gray-50 rounded-2xl p-8 shadow-lg">
                ...
                <button
                  onClick={onGetQuote}
                  className="w-full bg-[#be0e0c] hover:bg-[#9f0b0a] text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all transform hover:scale-105 shadow-lg mb-6"
                >
                ...
                <div className="pt-6 border-t border-gray-200">
                  ...
                  <a
                    href={brandConfig.contact.phoneHref}
                    className="block w-full bg-white hover:bg-gray-100 text-[#be0e0c] border-2 border-[#be0e0c] px-8 py-4 rounded-lg font-semibold text-lg transition-all text-center"
                  >
                    {brandConfig.contact.phone}
                  </a>
                </div>
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg">
              ...
              <div className="text-center">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 mt-4 text-[#be0e0c] hover:text-[#9f0b0a] font-semibold"
                >
                  <MapPin size={20} />
                  Get Directions
                </a>
