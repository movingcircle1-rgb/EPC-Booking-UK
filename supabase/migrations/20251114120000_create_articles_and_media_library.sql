/*
  ...
  1. New Tables
    - `articles`
      ...
      - `content` (text) - Article content (supports markdown/HTML)
    ...
    - `media_library`
      ...
      - `alt_text` (text) - Image alt text for SEO
      - `category` (text) - services, locations, partners, general
    ...
    - `page_seo_metadata`
      ...
      - `changefreq` (text) - Sitemap change frequency
      - `last_crawled` (timestamptz) - Last time crawled by search engines
      - `crawl_status` (text) - ok, error, pending
      - `created_at` (timestamptz)
      - `updated_at` (timestamptz)
  ...
  2. Security
    ...
    - Media library accessible by authenticated users
*/
